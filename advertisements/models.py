...
class Advertisement(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, related_name='ad_category', verbose_name='Category')
    location = models.ForeignKey(
        Location, on_delete=models.CASCADE, related_name='ad_location', verbose_name='Location')
    title = models.CharField(max_length=32, verbose_name='Title')
    description = models.TextField(blank=True, verbose_name='Description')
    price = models.IntegerField(default=0, verbose_name='Price')
    phone_number = models.CharField(
        verbose_name='Mobile Number', max_length=13)
    status = models.PositiveSmallIntegerField(
        default=NEW, choices=ATTRIBUTE_TYPE_FIELDS)
